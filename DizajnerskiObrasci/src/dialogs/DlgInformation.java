...
public class DlgInformation extends JDialog {

	private static final long serialVersionUID = 1L;
	private JPanel panel = new JPanel();
	private boolean confirm;
	
	public DlgInformation(String textContent) {
		...
		ImageIcon iconDefault = new ImageIcon("res/icons/customDialogs/information.png");
