...
public class DlgCircle extends JDialog {
	...
	public DlgCircle(Color defaultBorderColor, Color defaultInnerColor) {
		setModal(true);
		setResizable(false);
		setUndecorated(true);
		...
		buttonBorderColor.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				Color tempColor = JColorChooser.showDialog(null, "Choose the border color of the circle", defaultBorderColor);
				if(tempColor != null) {
		...
		buttonInnerColor.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				Color tempColor = JColorChooser.showDialog(null, "Choose the inner color of the circle", defaultInnerColor);
				if(tempColor != null) {
				...
				try {
					if(textFieldX.getText().isEmpty() || textFieldY.getText().isEmpty() || textFieldRadius.getText().isEmpty()) {
						...
						if (selectedCircle == null) {
							newCircle = new Circle(center, radius, false, newBorderColor, newInnerColor);
						} else {
							modifiedCircle = new Circle(center, radius, selectedCircle.isSelected(), newBorderColor, newInnerColor);
						}
						confirm = true;
						setVisible(false);
						dispose();
	...
	public Circle getModifiedCircle() {
		return modifiedCircle;
	}
	
	public void createNewCircle(MouseEvent e) {
	...
	public void setSelectedCircle(Circle selectedCircle) {
		...
		textFieldX.setText(Short.toString(selectedCircle.getCenter().getX()));
		textFieldY.setText(Short.toString(selectedCircle.getCenter().getY()));
		textFieldRadius.setText(Short.toString(selectedCircle.getRadius()));
		newBorderColor = selectedCircle.getBorderColor();
		newInnerColor = selectedCircle.getInnerColor();
		buttonBorderColor.setBackground(newBorderColor);
		buttonInnerColor.setBackground(newInnerColor);
	}
